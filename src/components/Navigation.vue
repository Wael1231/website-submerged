  ...
  <nav class="nav">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:block sm:ml-6">
            <div class="flex space-x-4">
              <a href="/" class="bg-purple-900 text-white px-3 py-2 rounded-md text-sm font-medium">Homepage</a>
    ...
    <div v-if="menuOpen" class="sm:hidden" id="mobile-menu">
      <div class="px-2 pt-2 pb-3 space-y-1">
        <a href="/" class="bg-purple-900 text-white block px-3 py-2 rounded-md text-base font-medium">Homepage</a>
